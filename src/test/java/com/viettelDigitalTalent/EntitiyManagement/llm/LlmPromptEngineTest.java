...
class LlmPromptEngineTest {
    ...
    @Test
    void buildIncludesFindingTitleField() {
        String result = engine.build("test input");
        assertThat(result).contains("\"finding\"");
    ...
    @Test
    void buildIncludesDestinationIpField() {
        String result = engine.build("test");
        assertThat(result).contains("\"dst_endpoint\"");
    ...
    @Test
    void mockClientReturnsValidJsonWithFindingTitle() {
        MockLlmClient mock = new MockLlmClient();
        String output = mock.call("any prompt");

        assertThat(output).contains("\"finding\"");
